...
book1 = Books("Programmng_Python", 10, "Non-Fiction", "Kenn")
book2 = Books("Programmng_JavaScript", 10, "Non-Fiction", "Kevin")
book3 = Books("Programmng_HTML", 10, "Non-Fiction", "Erin")
